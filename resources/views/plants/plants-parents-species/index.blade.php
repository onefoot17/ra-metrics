...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Plant Parents Species</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Plant <small> group</small></h1>
    <!-- end page-header -->
        ...
        <div class="panel-body">
            <form action="{{route('plant_parents_species_store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row m-b-15">
                    <label class="col-form-label col-md-3">Specie name</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control m-b-5" placeholder="Enter specie name" name="plant_specie_name" id='plant_specie_name' />
                    </div>
                </div>
                <div class="form-group row m-b-15">
