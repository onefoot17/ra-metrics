            ...
            <div class="header-nav-main header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
                <nav class="collapse">
                    <ul class="nav nav-pills justify-content-center" id="mainNav">
                        @if ( Auth::check() )
                            <li class="dropdown">
                                <a class="dropdown-item" data-hash data-hash-offset="68" href="{{ route('admin_home', [ Request::segment( 1 ) ] ) }}">
                        ...
                        <li>
                            <a class="dropdown-item" data-hash data-hash-offset="68" href="#participants">
                                <i class="fe-users mr-1"></i> @lang( 'Participants' )
                            </a>
                        </li>

                        <li>
                            <a class="dropdown-item" data-hash data-hash-offset="68" href="{{ route('about', [ Request::segment( 1 ) ] ) }}">
                                <i class="fas fa-globe mr-1"></i> @lang( 'About' )
                            </a>
                        </li>
