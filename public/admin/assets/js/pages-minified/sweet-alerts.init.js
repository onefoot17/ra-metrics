    ...
    (e.prototype.init = function () {
        t("#sa-basic").on("click", function () {
            ...
            t("#sa-image").click(function () {
                Swal.fire({ title: "UBold", text: "Responsive Bootstrap 4 Admin Dashboard", imageUrl: "../assets/images/logo-sm.png", imageHeight: 50, animation: !1, confirmButtonClass: "btn btn-confirm mt-2" });
            }),
